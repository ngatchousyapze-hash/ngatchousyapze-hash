...
- Surveillance SOC & Analyse d’alertes  
...
|-------|-------------|--------|
| 🔍 SOC Lab | Lab de détection d’attaques | Wazuh / ELK |
| 🐍 Log Analyzer | Analyseur de logs Python | Python |
| 🌐 Network Scan | Scanner réseau automatisé | Nmap / Bash |
