...
- Élaboration de politiques de sécurité (PSSI)  
- Gestion de la conformité réglementaire  
- Sensibilisation & gestion des audits  
...
|-------|-------------|-------------|
| 📊 Cartographie des risques | Analyse des risques SI | EBIOS / ISO 27005 |
| 📜 Politique Sécurité | Rédaction PSSI complète | Gouvernance |
| 🛡️ Audit ISO 27001 | Simulation audit interne | Conformité |
| 📁 PCA/PRA | Plan de continuité activité | Gestion de crise |

---

## 📈 Objectifs actuels

- Approfondir ISO 27001 Lead Implementer  
- Maîtriser EBIOS RM  
- Développer compétences Audit & Risk Management  
...
> “La sécurité ne se limite pas à la technique, elle commence par la gouvernance.” 🛡️
